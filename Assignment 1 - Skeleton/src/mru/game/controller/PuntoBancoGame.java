...
public class PuntoBancoGame {
	...
	public String runGame() {
		...
		String header="+"+"=".repeat(23)+"+"+"=".repeat(23)+"+\n"
				+"||PLAYER"+" ".repeat(16)+"|BANKER"+" ".repeat(16)+"||\n";
		...
		} else if (playersCards2.contains("King") || playersCards2.contains("Queen") || playersCards2.contains("Jack")) {
			playerValue += 10;
		...
		} else if (bankersCards2.contains("King") || bankersCards2.contains("Queen") || bankersCards2.contains("Jack")) {
			bankerValue += 10;
		...
		/**
		 * THIRD ROUND
		 * ONLY HAPPENS IF; IF STATEMENTS CONDITIONS ARE MET
		 */
		...
		if(playerValue >= 0 && playerValue <= 6) {
			...
			} else if (playersCards3.contains("King") || playersCards3.contains("Queen") || playersCards3.contains("Jack")) {
				playerValue += 10;
			...
			//If the Player did not draw a card, the Banker draws if he (the Banker) has 0-5, and stands if he has 6-7
			if(playerValue >= 7 && playerValue <= 9) {
				if(bankerValue >= 0 && bankerValue <= 5) {
					...
					} else if (bankersCards3.contains("King") || bankersCards3.contains("Queen") || bankersCards3.contains("Jack")) {
						bankerValue += 10;
			...
			//If the Player drew a 2 or 3, the Banker draws if he (the Banker) has 0-4, and stands if he has 5-7.
			...
			/**
			 * If the Player drew an Ace, 9, 10, or face card (Jack, Queen or King), the Banker draws if he
			 * has 0-3, and stands if he has 4-7
			 */
			if(pThirdCard.equals("King") || pThirdCard.equals("Queen") || pThirdCard.equals("Ace") || pThirdCard.equals(9) 
					|| pThirdCard.equals("10")) {
